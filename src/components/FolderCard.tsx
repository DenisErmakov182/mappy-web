    ...
    >
      <FolderArt coverPhotos={coverPhotos}>
        ...
        {/* size="m" (28px, иконка 20px), не "xs" — перепроверено 20.08.2026
            ...
            Фон — ghost/прозрачный, как в Figma (пробовал тёмную подложку-
            кружок, владелец отменил — полупрозрачность нужна самой кнопке,
            не окружению). opacity 0.7 на кнопке целиком, не отдельным
            слоем — тот же смысл, что «полупрозрачные белые иконки», частый
            приём в iOS поверх фото. */}
